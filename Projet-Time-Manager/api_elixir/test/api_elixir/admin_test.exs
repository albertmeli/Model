defmodule ApiElixir.AdminTest do
  ...
  describe "users" do
    ...
    import ApiElixir.AdminFixtures

    @invalid_attrs %{name: nil, firstname: nil, email: nil}
    ...
    test "create_user/1 with valid data creates a user" do
      valid_attrs = %{name: "some name", firstname: "some firstname", email: "some email"}
    ...
    test "update_user/2 with valid data updates the user" do
      user = user_fixture()
      update_attrs = %{name: "some updated name", firstname: "some updated firstname", email: "some updated email"}
