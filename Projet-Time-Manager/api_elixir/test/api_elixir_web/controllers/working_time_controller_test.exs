defmodule ApiElixirWeb.WorkingTimeControllerTest do
  ...
  @update_attrs %{
    start_shift: ~N[2023-10-24 14:31:00],
    end_shift: ~N[2023-10-24 14:31:00]
  }
  ...
  describe "create working_time" do
    test "renders working_time when data is valid", %{conn: conn} do
      ...
      assert %{
               "id" => ^id,
               "end_shift" => "2023-10-23T14:31:00",
               "start_shift" => "2023-10-23T14:31:00"
  ...
  describe "update working_time" do
    ...
    test "renders working_time when data is valid", %{conn: conn, working_time: %WorkingTime{id: id} = working_time} do
      ...
      assert %{
               "id" => ^id,
               "end_shift" => "2023-10-24T14:31:00",
               "start_shift" => "2023-10-24T14:31:00"
             } = json_response(conn, 200)["data"]
    end
